...
$\begin{aligned}
		...
		\label{ClassTopoLogClassical}
		 ...
		 & 14.\hspace*{35pt}TermCount:=TermCount+1\verb|\\|\text{所有零入度课程均已安排，学期数加1}                                       \\
		 & 15.\hspace{15pt}\textbf{return }TermCount\verb|\\|\text{最少学期数}                                                            \\
		\hline
	\end{aligned}
$
\newpage
...
$\begin{aligned}
		...
		\hline
		 ...
		 & 21.\hspace*{35pt}TermCount:=TermCount+1\verb|\\|\text{所有零入度课程均已安排，学期数加1}                                     \\
		 & 22.\hspace{15pt}\textbf{return }TermCount\verb|\\|\text{最少学期数}                                                          \\
		\hline
	\end{aligned}
$
\section*{Chapter 5}
